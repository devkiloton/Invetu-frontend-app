...
function Layout() {
  return (
    <div className="relative">
      <div className="py-4 px-8 sticky top-0">
        <div className="navbar glass rounded-box">
...
const InnerRouter = () => {
  ...
  return <>{state.state === 'UNKNOWN' ? <Loading /> : <Suspense fallback={<Loading />}>{element}</Suspense>}</>;
};
